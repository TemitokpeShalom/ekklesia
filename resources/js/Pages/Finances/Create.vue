    ...
    <div class="min-h-screen bg-slate-50">
        <header class="border-b border-slate-200 bg-white">
            <div class="mx-auto flex max-w-2xl items-center justify-between px-6 py-5">
                <h1 class="text-xl font-semibold text-slate-900">Nouveau mouvement</h1>
                ...
                <section class="border-t border-slate-100 pt-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input v-model="form.counterparty" type="text" placeholder="Nom du fidèle, fournisseur..." class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm transition focus:border-slate-400 focus:outline-none focus:ring-4 focus:ring-slate-100" />
                        </div>
                        <div>
