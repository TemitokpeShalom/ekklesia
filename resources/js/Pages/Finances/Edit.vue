...
<template>
    <AppLayout :org-unit="orgUnit" :back-href="`/org-units/${orgUnit.id}/finances`" back-label="Retour">
        <template #title>
            <div class="animate-[fadeInUp_0.5s_ease-out_both]">
                ...
                <h1 class="font-serif text-5xl font-bold text-graphite mt-2">Modifier le mouvement</h1>
            </div>
        </template>
                ...
                <section class="border-t border-graphite/10 pt-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input v-model="form.amount" type="number" min="0" step="0.01" class="w-full bg-graphite/5 border border-graphite/15 text-graphite rounded-xl px-3.5 py-2.5 text-sm transition focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold/60" />
                ...
                <section class="border-t border-graphite/10 pt-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input v-model="form.counterparty" type="text" class="w-full bg-graphite/5 border border-graphite/15 text-graphite placeholder-graphite/55 rounded-xl px-3.5 py-2.5 text-sm transition focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold/60" />
                        </div>
                        <div>
