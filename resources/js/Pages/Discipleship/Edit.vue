    ...
    <AppLayout :org-unit="orgUnit" :back-href="`/org-units/${orgUnit.id}/parcours`" back-label="Annuler">
        <template #title>
            <div class="animate-[fadeInUp_0.5s_ease-out_both]">
                ...
                <h1 class="font-serif text-3xl text-graphite mt-2">Modifier l'étape</h1>
            </div>
        </template>
        ...
        <div class="max-w-2xl mx-auto">
            <form @submit.prevent="submit" class="space-y-8 glass-panel rounded-3xl p-6 md:p-7 animate-[fadeInUp_0.55s_ease-out_both]">
                <section>
                    <h2 class="text-xs font-semibold text-sanctuary/80 uppercase tracking-widest mb-4">Membre concerné</h2>
                ...
                <section class="border-t border-graphite/10 pt-6">
                    <h2 class="text-xs font-semibold text-sanctuary/80 uppercase tracking-widest mb-4">Étape franchie</h2>
                ...
                <section class="border-t border-graphite/10 pt-6">
                    <h2 class="text-xs font-semibold text-sanctuary/80 uppercase tracking-widest mb-4">Date</h2>
                ...
                <section class="border-t border-graphite/10 pt-6">
                    <h2 class="text-xs font-semibold text-sanctuary/80 uppercase tracking-widest mb-4">Notes</h2>
