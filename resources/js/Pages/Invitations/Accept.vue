...
<template>
    <div class="app-shell min-h-screen flex items-center justify-center px-4 relative overflow-hidden bg-paper">
        ...
        <div v-if="!valid"
            ...
            <h1 class="font-serif text-4xl font-bold text-graphite mb-2">Invitation invalide</h1>
        ...
        <form v-else @submit.prevent="submit"
            ...
            <h1 class="font-serif text-4xl font-bold text-graphite mb-1">Créer votre compte</h1>
