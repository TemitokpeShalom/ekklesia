    ...
    <AppLayout :org-unit="orgUnit" :back-href="`/org-units/${orgUnit.id}/inventaire`" back-label="Retour à l'inventaire">
        <template #title>
            <div class="animate-[fadeInUp_0.5s_ease-out_both]">
                ...
                <h1 class="font-serif text-3xl text-graphite mt-2">Fiche d'inventaire consolidée</h1>
        ...
        <div class="max-w-4xl mx-auto space-y-8">
            ...
            >
                <div class="mb-4 flex items-center justify-between">
                    <h3 class="text-xs font-semibold text-sanctuary/80 uppercase tracking-widest">{{ cat.label }}</h3>
            ...
            <p class="text-xs text-graphite/58">Cette fiche est calculée automatiquement depuis le registre des biens, jamais ressaisie séparément.</p>
        </div>
    </AppLayout>
</template>
