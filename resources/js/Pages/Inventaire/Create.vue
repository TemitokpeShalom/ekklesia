    ...
    <div class="min-h-screen bg-slate-50">
        <header class="border-b border-slate-200 bg-white">
            <div class="mx-auto flex max-w-2xl items-center justify-between px-6 py-5">
                <h1 class="text-xl font-semibold text-slate-900">Nouveau bien</h1>
            ...
            <form @submit.prevent="submit" class="space-y-8 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
                <section>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input v-model="form.label" type="text" placeholder="Bâtiment principal, chaises plastiques..." class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm transition focus:border-slate-400 focus:outline-none focus:ring-4 focus:ring-slate-100" />
                            <p v-if="form.errors.label" class="mt-1 text-sm text-rose-600">{{ form.errors.label }}</p>
                            <p class="mt-1 text-xs text-slate-400">Le code d'identification (ex. BAT-000012) est généré automatiquement à l'enregistrement.</p>
                        </div>
                        <div>
                ...
                <section class="border-t border-slate-100 pt-6">
                    ...
                    <div v-if="depenses.length > 0" class="mt-4">
                        ...
                        <p class="mt-1 text-xs text-slate-400">Évite de ressaisir le montant si ce bien a déjà été payé comme dépense dans le module Finances.</p>
                    </div>
                </section>
