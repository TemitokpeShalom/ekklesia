    ...
    public function run(): void
    {
        $articles = [
            ...
            [
                'slug' => 'discipleship',
                'module' => 'Membres & présence',
                'title' => 'Parcours de disciple',
                'order' => 6,
                'body' => "Cet écran suit, pour chaque membre, l'étape la plus récente de sa croissance spirituelle : nouveau converti, baptisé, en formation, engagé dans le service, ou envoyé/leader. La liste affiche l'étape actuelle de chaque membre ; \"Enregistrer une étape\" ouvre un petit formulaire pour choisir le membre, l'étape franchie, la date, et une note facultative.\n\nChaque étape enregistrée reste conservée, même une fois qu'une étape plus avancée a été ajoutée pour le même membre : rien ne s'efface, seule l'étape la plus récente s'affiche sur cet écran. Cela reste distinct de l'écran Sacrements : le baptême y est enregistré comme cérémonie (date, lieu, officiant), tandis qu'ici il n'est qu'un jalon parmi d'autres dans le cheminement de la personne.\n\nLes cinq étapes proposées sont fixes, communes à tout le ministère, pour que le parcours reste comparable d'une église à l'autre. Seuls le responsable du nœud et le Secrétaire général peuvent enregistrer, corriger ou retirer une étape.",
            ],
            [
                'slug' => 'teams',
                'module' => 'Membres & présence',
                'title' => 'Équipes et bénévolat',
                'order' => 7,
                'body' => "Cet écran organise les équipes de service (accueil, louange, enfants, technique, ou toute autre équipe propre au ministère) et affecte les membres à chacune. Créer une équipe ne demande qu'un nom et une description facultative ; l'ouvrir ensuite permet d'y ajouter ou d'en retirer des membres, chacun avec un rôle libre dans l'équipe (par exemple \"responsable\") et une date d'entrée facultative.\n\nUn même membre peut appartenir à plusieurs équipes en même temps, mais ne peut apparaître qu'une seule fois dans une même équipe. Supprimer une équipe retire automatiquement tous les membres qui y étaient affectés, sans toucher à leurs fiches. Seuls le responsable du nœud et le Secrétaire général peuvent créer une équipe, la modifier, la supprimer, ou en gérer la composition.",
            ],
            [
                'slug' => 'finances',
                'module' => 'Finances',
                ...
                'order' => 8,
                'body' => "Chaque entrée ou sortie d'argent (dîme, offrande, action de grâce, don, dépense) se saisit ici avec : le type de mouvement, le compte comptable correspondant (tiré du plan de comptes SYSCOHADA configuré pour ce ministère), le montant, le mode de règlement (facultatif : espèces, chèque, virement bancaire, Mobile Money, ou autre), la date, la personne ou l'organisme concerné (facultatif), et une description.\n\nLe mode de règlement est une simple précision saisie à la main, comme les autres champs : aucune passerelle de paiement n'y est reliée, il sert uniquement à tracer par quel canal l'argent est entré ou sorti.\n\nCette liste alimente directement le rapport financier mensuel : rien n'est ressaisi. Le Trésorier porte la responsabilité pleine des finances de son périmètre ; le Comptable, quand ce poste existe sur ce nœud, peut saisir les écritures courantes sans pouvoir les valider. Une correction reste libre tant que le rapport du mois n'a pas été validé ; après validation, toute correction doit passer par une écriture de régularisation datée, jamais par une modification silencieuse.",
            ],
            [
